...
#if 0 // High-contention stress belongs in the future benchmark/load suite.
/**
 ...
 * <ul>
 *   <li>This test checks correctness under contention as a safety net.</li>
...
#if 0 // Concurrent retry-volume workload is excluded from correctness CTest.
